...
class Employee:
    ...
    def __init__(self,employee_id,name_employee,last_name_employee,email,password,salary):
...
# This is a Setter
    ...
    def create_user(self, employees):
        ...
        self._employee_id = input("Id of the employee")
        employee.append(self._employee_id)
        self._name_employee = input("Name of the employee")
        employee.append(self.name_employee)
        self._last_name_employee = input("Lastname of the employee")
        employee.append(self._last_name_employee)
        self._email = input("Email of the employee")
        employee.append(self._email)
        self._password = input("Password of the employee")
        employee.append(self._password)
        self._salary = input("Salary of the employee")
